...
<body style="padding-top: 50px;">
	...
	<h1 style="margin-left:390px;">신고사유</h1>
    	...
    	<tr>
  		...
  		<tbody>
  		 ...
  		 <c:forEach var="co" items="${coreportReason}"  > 
    		<tr>
      			<td>${co.reporter}</td>
      			<td>${co.type}</td>
      			<td>${co.reason}</td>
	...
	<center class="ct">
			<button type="button" class="btn-primary btn-sm" onclick="coguilt('<%=idx %>','${dco}');"><span>유죄</span></button>
			<button type="button" class="btn-red btn-sm" onclick="coacquit('<%=idx %>','${dco}');"><span>무죄</span></button>	
	</center>
	</div>
	</div>
	</div>
